...
phrase <user.text> [halt]: user.insert_formatted(text, "NOOP")
# phrase <user.text> {user.phrase_ender}:
#     user.insert_formatted(text, "NOOP")
#     key(phrase_ender)
{user.prose_formatter} <user.prose> [halt]: user.insert_formatted(prose, prose_formatter)
<user.format_text>+ [halt]: user.insert_many(format_text_list)
# <user.format_text>+ {user.phrase_ender}:
